...
abstract class $AnswerCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String content, String writeTime});
}
...
class _$_Answer implements _Answer {
  _$_Answer({required this.id, required this.content, required this.writeTime});
  ...
  @override
  String toString() {
    return 'Answer(id: $id, content: $content, writeTime: $writeTime)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, content, writeTime);
...
abstract class _Answer implements Answer {
  factory _Answer(
      ...
      required final String writeTime}) = _$_Answer;
