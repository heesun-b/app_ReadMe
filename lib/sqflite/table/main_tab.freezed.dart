...
/// @nodoc
@JsonSerializable()
class _$_MainTab with DiagnosticableTreeMixin implements _MainTab {
  _$_MainTab({required this.requestName, required this.name});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'MainTab(requestName: $requestName, name: $name)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'MainTab'))
...
abstract class _MainTab implements MainTab {
  factory _MainTab(
      ...
      required final String name}) = _$_MainTab;
